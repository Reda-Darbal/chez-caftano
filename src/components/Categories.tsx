  ...
  const categories = [
    {
      ...
      products: [
        { src: "/images/products/bleu-kaftan-vent-font.png", alt: "Caftan Bleu Vente - Face" },
        { src: "/images/products/bleu-kaftan-vent-back.png", alt: "Caftan Bleu Vente - Dos" },
        { src: "/images/products/dark-kaftan-front-vente.png", alt: "Caftan Bleu Nuit Vente - Face" },
        { src: "/images/products/dark-kaftan-back-vente.png", alt: "Caftan Bleu Nuit Vente - Dos" },
        { src: "/images/products/red-kaftan-vent-front.png", alt: "Caftan Rouge Vente - Face" },
        { src: "/images/products/red-kaftan-vent-back.png", alt: "Caftan Rouge Vente - Dos" },
        { src: "/images/products/white-kaftan-vente-front.png", alt: "Caftan Blanc Vente - Face" },
        { src: "/images/products/white-kaftan-vente-back.png", alt: "Caftan Blanc Vente - Dos" },
        { src: "/images/products/bleu-takchita-location-front.png", alt: "Takchita Bleue Location - Face" },
        { src: "/images/products/bleu-location-takchita-back.png", alt: "Takchita Bleue Location - Dos" },
        { src: "/images/products/darkbleu-location-takchita-front.png", alt: "Takchita Bleu Sombre Location - Face" },
        { src: "/images/products/darkbleu-location-takchita-back.png", alt: "Takchita Bleu Sombre Location - Dos" },
        { src: "/images/products/green-location-tekchita.png", alt: "Takchita Verte Location" },
        { src: "/images/products/side-green-takchita-location.png", alt: "Takchita Verte Location - Profil" },
    ...
    },
    {
      ...
      products: [
        { src: "/images/products/white-djelaba-vent-front.png", alt: "Djellaba Blanche Vente - Face" },
        { src: "/images/products/white-djelaba-vent-back.png", alt: "Djellaba Blanche Vente - Dos" },
        { src: "/images/products/whitecasse-djelaba-front-vent.png", alt: "Djellaba Blanc Cassé Vente - Face" },
        { src: "/images/products/whitecasse-djelaba-back-vent.png", alt: "Djellaba Blanc Cassé Vente - Dos" },
